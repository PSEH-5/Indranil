...
public Player(String player_key, String player_name, String player_number, String player_country, String player_type,
		String player_age, String player_match_played, String player_goals, String player_yellow_cards,
...
public String toString() {
	return "Player [player_key=" + player_key + ", player_name=" + player_name + ", player_number=" + player_number
			+ ", player_country=" + player_country + ", player_type=" + player_type + ", player_age=" + player_age
